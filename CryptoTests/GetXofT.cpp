...
TEST(GetXofTest, SHAKE256_oneblock) {
...
TEST(GetXofTest, SHAKE256_two_block_edge) {
...
TEST(GetXofTest, SHAKE256_two_block) {
...
TEST(GetXofTest, SHAKE256_one_byte) {
    GetXofMainTestFunc(nullptr, 0, SHAKE256, 1, NO_ERROR, "46");
}

TEST(GetXofTest, SHAKE256_multiple) {
